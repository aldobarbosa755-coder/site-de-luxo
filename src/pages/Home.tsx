...
import { FADE_IN, PAGE_TRANSITION } from "../constants/animations";
...
export default function Home() {
  ...
  const ethosItems = useMemo(() => [
    { num: "01", title: t('ethos.01.title'), desc: t('ethos.01.desc') },
    { num: "02", title: t('ethos.02.title'), desc: t('ethos.02.desc') }
  ], [t]);
  ...
  return (
    <motion.div {...PAGE_TRANSITION}>
      ...
      <main>
        ...
        {/* Philosophy Section */}
        <section className="py-24 md:py-32 lg:py-stack-lg bg-surface relative overflow-hidden" id="philosophy">
          <div className="editorial-grid">
            <motion.div 
              {...FADE_IN}
              className="col-start-1 col-end-13 flex flex-col items-center text-center"
            >
              <TextReveal delay={0.2} className="h-[1px] bg-primary/10 mb-20 w-40 mx-auto" />
              <SectionHeader 
                label={t('philo.label')}
                title={t('philo.title')}
                titleClassName="text-5xl md:text-8xl mb-32 md:mb-40"
        ...
        <section className="bg-surface py-24 md:py-32 lg:py-stack-lg border-t border-primary/5" id="atelier">
          <div className="editorial-grid items-center gap-y-24 md:gap-y-32">
            ...
            <div className="col-start-1 col-end-13 lg:col-start-7 lg:col-end-13 text-center flex flex-col items-center order-1 lg:order-2">
              <SectionHeader 
                label={t('atelier.label')}
                title={t('atelier.title')}
                description={t('atelier.p')}
                titleClassName="text-5xl md:text-8xl lg:text-7xl mb-12 md:mb-16"
                className="mb-12 md:mb-16"
              />
              <div className="space-y-12 md:space-y-16 w-full flex flex-col items-center">
                {atelierFeatures.map((item, idx) => (
                  <div key={item.title}>
        ...
        <section className="pt-24 md:pt-32 lg:pt-stack-lg pb-24 md:pb-32 lg:pb-stack-lg bg-surface border-b border-primary/5">
          <div className="editorial-grid">
            <motion.div {...FADE_IN} className="col-start-1 col-end-13 lg:col-start-2 lg:col-end-12 grid grid-cols-1 lg:grid-cols-3 gap-32 lg:gap-32">
              {processSteps.map((item) => (
                <div key={item.step} className="flex flex-col items-center gap-12 relative p-12 md:p-24 lg:p-12 group/card transition-all duration-1000 text-center">
        ...
        <section className="py-24 md:py-32 lg:py-stack-lg bg-surface">
          <div className="editorial-grid gap-y-32 md:gap-y-0">
            {ethosItems.map((item, idx) => (
              <div 
                key={item.num}
                className={`col-start-1 col-end-13 group text-center flex flex-col items-center ${
                  idx === 0 
                    ? "md:col-start-2 md:col-end-6 lg:col-start-1 lg:col-end-5" 
                    : "md:col-start-7 md:col-end-12 lg:col-start-7 lg:col-end-11 md:mt-32 lg:mt-60"
                }`}
              >
                <TextReveal>
                  <span className="font-sans text-[10px] md:text-[13px] lg:text-[10px] font-bold text-primary/30 group-hover:text-primary transition-colors duration-700 tracking-[0.6em] mb-12 md:mb-16 block">{item.num}</span>
                </TextReveal>
                <TextReveal delay={0.2}>
                  <h3 className="font-serif text-4xl md:text-6xl lg:text-4xl mb-12 md:mb-16">{item.title}</h3>
                </TextReveal>
        ...
        <section className="py-24 md:py-32 lg:py-stack-lg bg-surface overflow-hidden border-t border-primary/5">
          <div className="editorial-grid pt-40 md:pt-32">
            <motion.div {...FADE_IN} className="col-start-1 col-end-13 text-center">
              <SectionHeader 
                label={t('sensory.label')}
                title={t('sensory.title')}
                titleClassName="text-5xl md:text-7xl lg:text-9xl italic"
                className="mb-0 md:mb-0"
              />
              <div className="h-[1px] w-40 md:w-24 bg-primary/20 mx-auto mt-20 md:mt-32"></div>
            </motion.div>
          </div>
        </section>
                ...
                <div key={item.title} className="group cursor-pointer w-full max-w-sm md:max-w-xl lg:max-w-none">
                  <ImageReveal className={`aspect-${item.aspect} mb-12 md:mb-20 lg:mb-16`}>
                    <img 
                      ...
                      alt={item.title} 
                      width={1000}
                      height={item.aspect === 'square' ? 1000 : 1333}
                      loading="lazy"
                      decoding="async"
                    />
                  </ImageReveal>
          ...
          <div className="editorial-grid gap-y-32">
            <div className="col-start-1 col-end-13 lg:col-start-1 lg:col-end-6 flex flex-col justify-center items-center lg:items-start text-center lg:text-left order-2 lg:order-1 mt-20 lg:mt-0">
              <SectionHeader 
                ...
                description={t('heritage.p')}
                titleClassName="text-5xl md:text-7xl lg:text-8xl"
                centered={false}
                className="mb-0 md:mb-0 items-center lg:items-start"
              />
            </div>
            ...
            >
              <div className="relative w-full max-w-md md:max-w-lg lg:max-w-none">
                ...
                <ImageReveal className="aspect-[3/4] absolute top-[-60px] md:top-[-80px] lg:top-[-100px] left-[-40px] md:left-[-60px] lg:left-[-80px] w-full z-0 opacity-30 grayscale blur-[2px]">
                   <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuAPOEyoqyA_N3rH7TJ5gcjgfhn1CWwQE3lL6EqbsmSD2_-eHE8VHxhlHSh6cMK066fpAB8ts_vif00BmdZF8tyPPZI1fLueka1nFj5_HR78rMf2R5AYlfzZdtyGfachheBIMZwfb8WdNx8Fpr2k5e7FxGTU279Q9wGoOcU9EAuDhjdeTwHMeGe-DxOFoeMYVLvulxpiQpZVi80E1MrVHljn6jRoE2TdJ0oXg8qfGuGdn8NzI9hfgXtzfG7NyMysGgAAeFI_wDS_h0qg" className="w-full h-full object-cover" width={600} height={800} loading="lazy" decoding="async" alt="Heritage Secondary" />
                </ImageReveal>
              </div>
            </motion.div>
          </div>
          ...
          <div className="editorial-grid">
            <div className="col-start-1 col-end-13 text-center py-32 md:py-40 border-t border-primary/10">
              <SectionHeader 
                label={t('cta.label')}
                title={t('cta.title')}
                titleClassName="text-6xl md:text-7xl lg:text-9xl tracking-tighter"
